...
# Typography ![Ready Badge](https://img.shields.io/badge/component-ready-green.svg#badge)
...
Bluebird's font family is Open Sans.

## Font Weights

Three of the Open Sans font weights are available for use.

<Playground>
<p class="fsxl thin">Open Sans Light</p>
<p class="fsxl regular">Open Sans Regular</p>
<p class="fsxl bold">Open Sans Semibold</p>
</Playground>
...
<Playground>
  ...
  <p><del>Use the del tag to treat text as deleted</del></p>
  <p><s>Use the s tag to treet text with a strikethrough</s></p>
  <p><ins>Use the ins tag to treat text as inserted</ins></p>
  <p><u>Use the u tag to underline text</u></p>
  <p><small>Use the small tag to make text smaller</small></p>
  <p><strong>Use the bold or strong tags to make text bolder</strong></p>
  <p><em>Use the em tag to make text italicized</em></p>
</Playground>
...
The number of characters that appear on a given line of text influence the readability of that text. 

- Aim for line lengths between __45–75 characters__ for desktop devices and between __35–50 characters__ for mobile devices
- Optimal line lengths are __66 characters__ for desktop devices and __39 characters__ for mobile devices
- Anything above __90 characters__ on desktop devices and above __50 characters__ on mobile devices are too long

These guidelines are recommended for desktop and mobile devices:

__Desktop Line Length Guidelines__
![Desktop Line Lengths](../assets/DesktopLineLengths.png)

__Mobile Line Length Guidelines__
![Mobile Line Lengths](../assets/MobileLineLengths.png)
...
<Playground>
  <p>
    Use the <code>&lt;kbd&gt;</code> to indicate input that is typically entered
    via keyboard.
  </p>
  <p>
...
<Playground>
  <p>
    Use <code>&lt;pre&gt;</code> for multiple lines of code. Be sure to escape
