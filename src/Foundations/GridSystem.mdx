...
<Playground>
  <Grid fluid={true}>
    ...
    <div className="red-element">
      <div className="p3">{'<Row />'}</div>
      <Row>
        <Col md={6}>
          <div className="blue-element m1">
            <div className="p3">{'<Col />'}</div>
          </div>
        </Col>
        <Col md={6}>
          <div className="blue-element m1">
  ...
  <Grid fluid={true}>
    ...
    <div className="red-element">
      ...
      <Row>
        <Col md={6}>
          <div className="blue-element m1">
            <div className="p3">{'<Col md={6}/>'}</div>
          </div>
        </Col>
        <Col md={9}>
          <div className="blue-element m1">
            <div className="p3">{'<Col md={9}/>'}</div>
          </div>
        </Col>
      </Row>
    </div>  
  ...
  <Grid fluid={true}>
    ...
    <div className="red-element mb3">
      ...
      <Row>
        <Col xs={12} md={8}>
          <div className="blue-element m1">
            <div className="p3">{'<Col xs={12} md={8} />'}</div>
          </div>
        </Col>
        <Col xs={6} md={4}>
          <div className="blue-element m1">
            <div className="p3">{'<Col xs={6} md={4} />'}</div>
          </div>
        </Col>
      </Row>
    </div>  
    ...
    <div className="red-element mb3">
      ...
      <Row>
        ...
        <Col xsHidden md={4} >
          <div className="blue-element m1">
            <div className="p3">{'<Col xsHidden md={4} />'}</div>
          </div>
        </Col>
      </Row>
    </div>  
    ...
    <div className="red-element mb3">
      ...
      <Row>
        <Col xs={6} xsOffset={6}>
          <div className="blue-element m1">
            <div className="p3">{'<Col xs={6} xsOffset={6} />'}</div>
          </div>
        </Col>
      </Row>
    </div>  
    ...
    <div  className="red-element mb3">
      ...
      <Row>
        <Col md={6} mdPush={6}>
          <div className="blue-element m1">
            <div className="p3">{'<Col md={6} mdPush={6} />'}</div>
          </div>
        </Col>
        <Col md={6} mdPull={6}>
          <div className="blue-element m1">
            <div className="p3">{'<Col md={6} mdPull={6} />'}</div>
          </div>
        </Col>
      </Row>
    </div>  
