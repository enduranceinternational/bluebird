...
# Dropdowns ![Ready Badge](https://img.shields.io/badge/component-ready-green.svg#badge)
...
<Playground>
  {() => {
    ...
    return <Dropdown placeholder='Skills' fluid multiple search selection options={options} />
  }}
</Playground>
