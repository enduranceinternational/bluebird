...
Atomic variables used to help maintain consistency across our composed app styles. Prefer using the variables here over hard-coded values where possible.
...
| ----------- | ----------- |
| `.br1` | border-radius small |
| `.br2` | border-radius |
| `.br3` | border-radius large |
| `.br-circle` | set round border-radius |
| `.no-border` | remove border |
| `.border-top-1` | add border-top |
| `.border-right-1` | add border-right |
| `.border-bottom-1` | add border-bottom |
| `.border-left-1` | add border-left |
| `.border-color-grey` | set border color to grey |
| `.border-solid` | set border to solid |
| `.depth1` | set shadow depth |
| `.depth2` | set shadow depth |
| `.depth3` | set shadow depth |
...
| `$xxl` | space |
| `$xxxl` | space |
| `$auto-min-width` | reset min-width to auto |
...
$font-size-h1: 38px !default;
$font-size-h1-mobile: 28px !default;
$font-size-h2: 28px !default;
$font-size-h2-mobile: 20px !default;
$font-size-h3: 20px !default;
$font-size-h4: 16px !default;
$font-size-h5: $font-size-base !default;
$font-size-h6: ceil(($font-size-base * .875)) !default; // ~14px
$font-size-s: ceil(($font-size-base * .8125)) !default; // ~13px
$font-size-xs: ceil(($font-size-base * .75)) !default; // ~12px
$font-size-xxs: ceil(($font-size-base * .625)) !default; // ~10px
...
$table-cell-padding: 8px !default; // TODO: this is getting overridden by .table :(
//** Padding for cells in `.table-condensed`.
$table-condensed-cell-padding: 8px; // $xs
...
$navbar-inverse-bg: $gray-base !default;
...
$progress-border-radius: $border-radius-large;
...
//
//##
$card-border-color: $default-border-color !default;
$card-box-shadow-color: $default-box-shadow-color !default;
```
