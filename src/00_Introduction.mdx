...
The Bluehost UI library is maintained in [Sketch](https://drive.google.com/open?id=1MIK8jwEdpLlEBOJ5G6tY7ixVZXFGtJSV). The Bluehost UI Library is hosted on google drive  - to gain access to this you will need to speak to the lead on the Bluehost Design system.

Sketch allows us to create a shared library of Bluehost’s foundational colors and text styles, and patterns and components that can be easily be used in your designs. This allows for rapid prototyping of features, using consistent elements from the design system. As the system is hosted on google drive, you can quickly sync the changes to your design(s).

#### How to set up the library

  - Download [Sketch](https://www.sketchapp.com/)
  - Once installed open  [Bluehost UI Library](https://drive.google.com/open?id=1MIK8jwEdpLlEBOJ5G6tY7ixVZXFGtJSV)
  - In Sketch, navigate to File → Add as Library
  - To manage your libraries click Sketch → Preferences → Libraries
