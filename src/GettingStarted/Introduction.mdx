...
- [Utility Classes](/#getting-started)
- [Grid System](/foundations-grid-system)
...
Creating UIs from scratch can be hard, but it doesn’t have to be. Blue Design System is here to guide you throughout the design and development processes to make composing new interactions simple. Our mantra has always been, "Let us solve the easy problems so that you can focus on the hard ones."
...
1. Install Yarn version 1.13.0 <a href="https://yarnpkg.com/en/docs/install#mac-stable">here</a>. NOTE: choose the option that doesn't include Node.
