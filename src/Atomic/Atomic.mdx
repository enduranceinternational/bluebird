...
| Class | Description |
| ----------- | ----------- |
| `$standard-border` | border-radius |
| `$brand-border` | border-radius |
| `$radius-s` | border-radius |
| `$radius-m` | border-radius |
| `$radius-l` | border-radius |
| `$width-s` | border-radius |
| `$width-m` | border-radius |
| `$width-l` | border-radius |
| `$style` | border-radius |
...
> Do not use breakpoints from Atomic, instead please use media queries from Bootstrap variables where applicable.

### Colors

See [Colors](/bootstrap-colors).
...
> Do not use this feature from our Atomic styles.
